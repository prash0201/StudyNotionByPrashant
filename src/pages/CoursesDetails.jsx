...
const CoursesDetails = () => {
  ...
  const getAvgReveiewCount = async () => {
    const count = GetAvgRating(
      courseData?.data?.coursesDetails.ratingAndReviews
    );
  ...
  const getTotalNoOfLectures = async () => {
    let lectures = 0;
    courseData?.data?.coursesDetails?.courseContent?.forEach((sec) => {
  ...
  return (
    ...
    //   {/* <p>{courseData.data[0]?.courseName}</p> */}
